...
public class Decoration : MonoBehaviour
{
    ...
    public bool m_addBlockFlyers, m_addUnblockFlyers, m_addBlockGround, m_addUnblockGround, m_addIsWater, m_addIsSolid, m_addIsShallow, m_addIsNotShallow, m_cancelTileDamage;
